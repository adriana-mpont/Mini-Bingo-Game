...
class NumberDrawer:
    ...
    #Defining the constructor, including the parameters for maximum number (99).
    def __init__(self, max_number: int = 99):
        #Storing the maximum number that can be drawn.
        self.max_number = max_number
        #Creating a set containing the numbers not yet drawn 
    ...
    def draw_number(self):
        ...
        if not self.available_numbers:
            #If there aren't, printing a message to tell the user that every number has been used.
            print(" All numbers have been drawn!")
            #Signaling that no new number could be drawn.
            return None
        ...
        #Adding the drawn number into the set of already selected number.
        self.drawn_numbers.append(number)
        #Returning the number drawn.
        return number
    ...
    def display_drawn_numbers(self):
        ...
        if self.drawn_numbers:
            ...
            #If numbers don't exist, telling the user no draws have ocurred yet. 
