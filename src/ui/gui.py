...
class MiniBingoGUI(tk.Tk):
    ...
    def show_intro(self):
        ...
        tk.Button(
            ...
            bg="#ffffff",
            fg="#29b6f6",
            command=lambda: [intro_win.destroy(), self.show_mode_selection()]
        ).pack(pady=10)
    ...
    def show_mode_selection(self):
        ...
        for mode_name, rounds, color in modes:
            ...
            tk.Label(
                frame,
                text=f"{mode_name} ({rounds} rounds)",
                font=("Arial", 14, "bold"),
                bg=color,
                fg="white"
            ...
            tk.Button(
                ...
                fg=color,
                font=("Arial", 12, "bold"),
                command=lambda r=rounds: set_mode(r)
    ...
    def end_round(self):
        ...
        tk.Button(
            ...
            bg="#4db6ac",
            fg="white",
            command=lambda: [replay_win.destroy(), self.start_game()]
        ...
        tk.Button(
            ...
            bg="#ff8a65",
            fg="white",
            command=lambda: [replay_win.destroy(), self.quit()]
